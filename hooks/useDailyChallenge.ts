...
function todayKey() { return `dharma_challenge_done_${new Date().toISOString().slice(0, 10)}`; }
function monthKey() { return `dharma_challenge_month_${new Date().toISOString().slice(0, 7)}`; }
