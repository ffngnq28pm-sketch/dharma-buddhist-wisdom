...
const PREFS_KEY = 'dharma_ambient_prefs_v1';
  ...
  if (!expanded) {
    return (
      ...
      >
        ...
        <Text style={[styles.pillText, { color: accent }]}>Activer l'audio méditatif</Text>
  ...
  return (
    <View style={[styles.panel, { backgroundColor: colors.bgSection, borderColor: colors.border }]}>
      <View style={styles.header}>
        <Text style={[styles.title, { color: colors.textPrimary }]}>🎵 Sons méditatifs</Text>
...
const styles = StyleSheet.create({
  ...
  pillText: { flex: 1, fontFamily: 'Cinzel_700Bold', fontSize: 12, letterSpacing: 0.5 },
  ...
  title: { fontFamily: 'Cinzel_700Bold', fontSize: 13, letterSpacing: 0.5 },
