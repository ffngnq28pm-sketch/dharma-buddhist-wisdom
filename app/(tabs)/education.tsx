      ...
      <Modal visible={screen === 'lesson'} animationType="slide" presentationStyle="pageSheet">
        <SafeAreaView style={[styles.modal, { backgroundColor: colors.bg }]}>
          ...
          <ScrollView contentContainerStyle={styles.lessonContent} showsVerticalScrollIndicator={false}>
            {activeLesson?.paliQuote && (
              <View style={[styles.quoteBox, { backgroundColor: colors.bgSection }]}>
                <Text style={[styles.quote, { color: colors.textAccent }]}>{activeLesson.paliQuote}</Text>
                {activeLesson.paliSource && (
                  <Text style={[styles.quoteSource, { color: colors.textMuted }]}>{activeLesson.paliSource}</Text>
                )}
              </View>
            )}
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.titleRow}>
          <View>
            ...
            <Text style={[styles.pageSubtitle, { color: colors.textMuted }]}>Bouddhisme · Dhamma & Éveil</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  quote: { fontSize: 16, fontFamily: 'serif', textAlign: 'center', lineHeight: 28, fontStyle: 'italic' },
