...
import { BuddhistCalendarWidget } from '@/components/BuddhistCalendarWidget';
import { MalaCounter } from '@/components/MalaCounter';
import { DailyChallengeWidget } from '@/components/DailyChallengeWidget';
import { DailyTeachingWidget } from '@/components/DailyTeachingWidget';
...
import { useBuddhistCalendar, PERIOD_THEMES } from '@/hooks/useBuddhistCalendar';
...
export default function HomeScreen() {
  ...
  const { period } = useBuddhistCalendar();
  ...
  const greeting = profile.firstName ? `Bonsoir, ${profile.firstName}` : 'Dharma · ☸ · Éveil';
