      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        {favoriteCards.length === 0 ? (
          <View style={styles.empty}>
            <View style={[styles.emptyIcon, { borderColor: 'rgba(198,124,43,0.25)', backgroundColor: 'rgba(198,124,43,0.1)' }]}>
              <Text style={styles.emptyWheel}>🙏</Text>
            </View>
            <Text style={[styles.emptyTitle, { color: colors.textPrimary }]}>Aucun favori</Text>
            <Text style={[styles.emptyText, { color: colors.textMuted }]}>
              Aucun favori — touchez ♥ sur une carte
            </Text>
          </View>
        ) : (
          <ScrollView
